...
import "./underlinetab.scss";

export default function UnderlineTabAnimation() {
  ...
  useEffect(() => {
    ...
    if (activeTab && container) {
      ...
      if (activeTabElement) {
        ...
        container.style.clipPath = `inset(90% ${Number(
